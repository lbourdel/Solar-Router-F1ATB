...
// String TokenEnphase = "eyJraWQiOiI3ZDEwMDA1ZC03ODk5LTRkMGQtYmNiNC0yNDRmOThlZTE1NmIiLCJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiJ9.eyJhdWQiOiIxMjIzMTIwNzc2MDciLCJpc3MiOiJFbnRyZXoiLCJlbnBoYXNlVXNlciI6Im93bmVyIiwiZXhwIjoxODE3NjIxNDQzLCJpYXQiOjE3ODYwODU0NDMsImp0aSI6IjM3MTZmMjZhLTI2ZDAtNGMxMi1hNmQ4LTAwZmM4MjU0YTAyMiIsInVzZXJuYW1lIjoibGJvdXJkZWxAeWFob28uZnIifQ.5qAskeLxItjzuUCzsxssD758d5SY6ctuWGEzZSTa5tTSVCAYfY4TuDM4KLhX4Bk8d4dXPBi8SHK8sDQ56ZftvQ";
  ...
  for (;;) {
    ...
    if (tps - LastRMS_Millis > PeriodeProgMillis) {  //Attention delicat pour eviter pb overflow
      ...
      if (Source == "Enphase") {
        LectureEnphase();
        LastRMS_Millis = millis();
        PeriodeProgMillis = 1500 + ralenti;  //On s'adapte à la vitesse réponse Envoy-S metered
      }
      if (Source == "SmartG") {
        LectureSmartG();
        LastRMS_Millis = millis();
